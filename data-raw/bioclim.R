...
bioclim <- tibble::tribble(
  ...
  "bio01", "Annual Mean Temperature", "dec C", "annual trends", 0.1, 0,
  ...
  "bio05", "Max Temperature of Warmest Month", "dec C", "extreme or limiting environmental factors", 0.1, 0,
  "bio06", "Min Temperature of Coldest Month", "dec C", "extreme or limiting environmental factors", 0.1, 0,
  "bio07", "Temperature Annual Range (bio05 - bio06)", "dec C", "annual trends", 0.1, 0,
  "bio08", "Mean Temperature of Wettest Quarter", "dec C", "extreme or limiting environmental factors", 0.1, 0,
  "bio09", "Mean Temperature of Driest Quarter", "dec C", "extreme or limiting environmental factors", 0.1, 0,
  "bio10", "Mean Temperature of Warmest Quarter", "dec C", "extreme or limiting environmental factors", 0.1, 0,
  "bio11", "Mean Temperature of Coldest Quarter", "dec C", "extreme or limiting environmental factors", 0.1, 0,
